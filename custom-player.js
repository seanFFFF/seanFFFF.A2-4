...
/* Set to open full screen pages */
/* Set some if events for the fullscreen feature to make it compatible across browsers */
...
/* Set to close full screen pages */
/* Set some if events for the fullscreen feature to make it compatible across browsers */
...
/* Set the volume listener to bind it to a slider*/
volSlider.addEventListener("input", (e) => {
 changeVolume(e.target.value)
 /* Set the target property to get the target parameters of the event object*/
})
